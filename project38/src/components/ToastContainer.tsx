...
function ToastItem({ toast, onClose }: ToastItemProps) {
  ...
  return (
    <div
      className={`flex items-center gap-3 p-4 rounded-lg border shadow-lg animate-slideIn ${config.bgColor} ${config.textColor}`}
...
export function ToastContainer() {
  ...
  const portal = document.getElementById('toast-root') || document.body;
