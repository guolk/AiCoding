...
export class MiniMap {
    ...
    draw(ctx, nodes, connections, viewState) {
    ...
    mapToWorld(mapPoint) {
        return {
            x: (mapPoint.x - this.config.position.x) / this.scale +
                this.contentBounds.x,
            y: (mapPoint.y - this.config.position.y) / this.scale +
    ...
    drawViewportIndicator(ctx, viewState) {
    ...
    getWorldPositionFromMapPoint(mapPoint, viewState) {
