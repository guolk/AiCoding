  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        pink: "border-transparent bg-pink-100 text-pink-700 hover:bg-pink-100/80",
        orange: "border-transparent bg-orange-100 text-orange-700 hover:bg-orange-100/80",
        teal: "border-transparent bg-teal-100 text-teal-700 hover:bg-teal-100/80",
      },
    },
    defaultVariants: {
      variant: "default",
