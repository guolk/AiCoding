...
const navItems = [
  ...
  { path: '/problems', label: '题目列表', icon: 'problems' },
  { path: '/contests', label: '竞赛列表', icon: 'contests' },
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <h1 className="text-xl font-bold text-white">CodeOJ 在线评测系统</h1>
      ...
      <footer className="bg-gray-800 text-gray-400 py-4 flex-shrink-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm">
          &copy; {new Date().getFullYear()} CodeOJ 在线评测系统
        </div>
      </footer>
    </div>
  );
